<template>
  <div class="mt-[30px]">
    <form
      class="mx-auto"
      @submit.prevent="registerPopup = true"
      @close-modal="registerPopup = false"
    >
      ...
      <div class="mb-4 relative">
        ...
        />
        <p
          v-if="password && isInvalidPassword"
    ...
    <div class="text-center text-sm">
      <p class="text-[#333333]">
        ...
        <nuxt-link
          to="/login"
          class="text-[#554AF0] font-semibold font-sm hover:underline"
        >
          Login
        </nuxt-link>
      </p>
